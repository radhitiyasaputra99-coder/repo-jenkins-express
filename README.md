...
> Sample app used for learning/testing a Jenkins pipeline. Sourced from
> [w3cj/express-api-starter](https://github.com/w3cj/express-api-starter) (MIT License, see `LICENSE`),
> with a `Jenkinsfile` added on top.
